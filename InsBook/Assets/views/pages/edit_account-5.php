			...
			<div class="tab-content">
				...
				<div class="tab-pane container active" id="menu2">
					<ul class="nav nav-tabs flex-column">
						...
						<li class="nav-item">
							<a class="nav-link active" href="http://localhost/messenger-frontend/views/pages/edit_account-5.php">Gia đình và các mối quan hệ</a>
						</li>
						<li class="nav-item">
					...
					<div class="tab-content">
						...
						<div class="tab-pane container active" id="menu2-5">
							<div class="family-and-relationship">
								<div class="family">
									<h3>Tình trạng mối quan hệ</h3>
									<ul class="list-family">
										<li class="list-family-item">
											<div class="family-item-thumbnail">
									...
									<div class="family-adding">
										<button type="button" class="btn btn-light"><i class="far fa-plus-square"></i><span>Thêm tình trạng quan hệ của bạn</span></button>
									</div>
								</div>
								<div class="relationship">
									<h3>Thành viên trong gia đình</h3>
									<ul class="list-relationship">
										<li class="list-relationship-item">
											<div class="relationship-item-thumbnail">
												<img src="http://localhost/messenger-frontend/media/78834391_459110258126325_6149001856166133760_n.jpg" alt="">
											</div>
											...
											<div class="relationship-item-tools">
												<i class="far fa-edit"></i>
												<i class="far fa-trash-alt"></i>
											</div>
										</li>
									...
									<div class="relationship-adding">
										<button type="button" class="btn btn-light"><i class="far fa-plus-square"></i><span>Thêm một thành viên gia đình</span></button>
									</div>
								</div>
							</div>
						</div>
